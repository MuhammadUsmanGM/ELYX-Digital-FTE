...
class OdooWatcher(BaseWatcher):
    ...
    def create_action_file(self, item) -> Path:
        ...
        elif item_type == 'payment_received':
            content = self._create_payment_received_action(item)
...
'''
    ...
    def _create_payment_received_action(self, item: dict) -> str:
...
## Suggested Actions
- [ ] Confirm payment in accounting records
